...
// This implementation is not meant to be the best implementation, it is meant to be
// a quick way to get someone started that does not want to write their own header.
